...
class Perplexity:
    ...
    def _s(self, query: str, mode: str = "concise", search_focus: str = "internet", attachments= [], language: str = "en-GB", in_page: str = None, in_domain: str = None) -> None:
    ...
    def search(self, query: str, mode: str = "concise", search_focus: str = "internet", attachments = [], language: str = "en-GB", timeout: float = 30, in_page: str = None, in_domain: str = None) -> Iterable[Dict]:
    ...
    def search_sync(self, query: str, mode: str = "concise", search_focus: str = "internet", attachments= [], language: str = "en-GB", timeout: float = 30, in_page: str = None, in_domain: str = None) -> dict:
        self._s(query, mode, search_focus, attachments, language, in_page, in_domain)
    ...
    def threads(self, query: str = None, limit: int = None):
    ...
    def list_autosuggest(self, query: str = "", search_focus: str = "internet"):
        assert self.finished, "already searching"
...
def call(Query):
    ...
    answer = perplexity.search(Query ,timeout=8)
    if answer=={"error": "timeout"}:
        print("serching on web ...")
        answer = perplexity.search(Query,timeout=80)
        if answer=={"error": "timeout"}:
            return None
